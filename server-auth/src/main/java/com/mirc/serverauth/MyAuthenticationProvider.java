...
//        String password = ;//MD5Util.encode( authentication.getCredentials().toString());// 这个是表单中输入的密码；
        ...
        //
        //
        //System.out.println("authenticate1__"+userInfo.getPassword()+"___"+password);



        if (passwordEncoder.matches(authentication.getCredentials().toString(),userInfo.getPassword())) {
            throw new BadCredentialsException("密码不正确");
        }
